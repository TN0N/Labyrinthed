...
const lights: array<Light, 10> = array<Light, 10>(
    Light(vec3(-6.0, -65.0, -1.0), vec3(1.0, 0.8, 0.5), 1.0), 
    Light(vec3(57.0, -50.0, 50.0), vec3(0.8, 1.0, 0.8), 0.8),
    Light(vec3(66.0, -50.0, 116.0), vec3(0.8, 1.0, 0.8), 0.8), 
    Light(vec3(-7.0, -35.0, 64.0), vec3(0.8, 1.0, 0.8), 0.8), 
    Light(vec3(127.0, -30.0, 101.0), vec3(0.8, 1.0, 0.8), 0.5),
